...
with open("shaders/uniformFragment.txt",'r') as f:
...
#get a pointer to the uniform in the shader
colourLocation = glGetUniformLocation(shader,"custom_color")
glUniform4f(colourLocation,0.0,1.0,0.0,1.0)
